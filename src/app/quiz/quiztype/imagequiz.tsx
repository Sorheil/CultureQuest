            ...
            <div className="grid grid-cols-2 gap-3 mb-4">
                {currentQuestion.options.map((option) => (
                    <div
                        ...
                        onClick={() => (quizState === "question" ? handleOptionClick(option.id) : null)}
                    >
                        ...
                        <span
                            ...
                            ${quizState === "correct" && selectedOption?.id === option.id ? "text-green-500" : ""}
                            ${quizState === "incorrect" && selectedOption?.id === option.id ? "text-red-500" : ""}`}
                        >
              {option.label}
            </span>
                    </div>
